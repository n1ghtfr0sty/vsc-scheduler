...
- Week view toggle
- Game events displayed on calendar days
- Color-coded events:
  - Green = Away game
  - Gold = Home game
  - Red = Conflict
- Click on day to see schedule for that date
- Click on event to view game details
- Today highlighting
- Responsive design
- Navigation: previous/next month, previous/next year, today button
